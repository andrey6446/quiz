  ...
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert(
      ...
      [
        {
          question:
            "Каким словом хозяин охарактеризовал неудачу своего питомца?",
          answer: "фиаско",
        ...
        {
          question:
            "За за какое место для посиделок данный персонаж списывает 100 рублей?",
          answer: "пенек",
        ...
        {
          question:
            "Лимур призывает вас к какому-ту действию, что нужно сделать?",
          answer: "узбагоиться",
          image: "/image/1-4.png",
          themeId: 1,
          createdAt: new Date(),
